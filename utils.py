...
TIME_STEPS = int(pipeline_romance._get_TIME_UPPER_BOUND() / pipeline_romance._get_TIME_INTERVAL())
FREQ_STEPS = int(pipeline_romance._get_FREQ_UPPER_BOUND() / pipeline_romance._get_FREQ_INTERVAL())

FINITE_DIFFERENCE_TIME = pipeline_romance._get_TIME_INTERVAL()
FINITE_DIFFERENCE_FREQ = pipeline_romance._get_FREQ_INTERVAL()

INTERP_NO = 14

# For each digit, the speakers in each language saying that digit
digit_speakers_germanic = {
    1: {
        enums.GermanicLanguages.BRITISH_AUSTRALIAN_ENGLISH: [
            enums.BritishAustralianEnglishSpeakers.SPEAKER_1,
            enums.BritishAustralianEnglishSpeakers.SPEAKER_3,
        ],
        enums.GermanicLanguages.DUTCH: [
            enums.DutchSpeakers.SPEAKER_1,
            enums.DutchSpeakers.SPEAKER_3,
            enums.DutchSpeakers.SPEAKER_4,
        ],
        enums.GermanicLanguages.GERMAN: [
            enums.GermanSpeakers.SPEAKER_1,
            enums.GermanSpeakers.SPEAKER_2,
            enums.GermanSpeakers.SPEAKER_4,
        ],
        enums.GermanicLanguages.SWEDISH: [
            enums.SwedishSpeakers.SPEAKER_1,
            enums.SwedishSpeakers.SPEAKER_2,
        ],
    },
    2: {
        enums.GermanicLanguages.BRITISH_AUSTRALIAN_ENGLISH: [
            enums.BritishAustralianEnglishSpeakers.SPEAKER_1,
            enums.BritishAustralianEnglishSpeakers.SPEAKER_2,
        ],
        enums.GermanicLanguages.DUTCH: [
            enums.DutchSpeakers.SPEAKER_1,
            enums.DutchSpeakers.SPEAKER_2,
            enums.DutchSpeakers.SPEAKER_3,
            enums.DutchSpeakers.SPEAKER_4,
        ],
        enums.GermanicLanguages.GERMAN: [
            enums.GermanSpeakers.SPEAKER_1,
            enums.GermanSpeakers.SPEAKER_2,
            enums.GermanSpeakers.SPEAKER_3,
            enums.GermanSpeakers.SPEAKER_4,
        ],
        enums.GermanicLanguages.SWEDISH: [
            enums.SwedishSpeakers.SPEAKER_1,
            enums.SwedishSpeakers.SPEAKER_2,
            enums.SwedishSpeakers.SPEAKER_3,
        ],
    },
    3: {
        enums.GermanicLanguages.BRITISH_AUSTRALIAN_ENGLISH: [
    ...
    5: {
        ...
        enums.GermanicLanguages.SWEDISH: [
            enums.SwedishSpeakers.SPEAKER_4,
        ],
    },
    6: {
        enums.GermanicLanguages.BRITISH_AUSTRALIAN_ENGLISH: [
        ...
        enums.GermanicLanguages.SWEDISH: [
            enums.SwedishSpeakers.SPEAKER_2,
            enums.SwedishSpeakers.SPEAKER_5,
        ],
    },
    7: {
        enums.GermanicLanguages.BRITISH_AUSTRALIAN_ENGLISH: [
    ...
    8: {
        ...
        enums.GermanicLanguages.SWEDISH: [
            enums.SwedishSpeakers.SPEAKER_6,
        ],
    },
    9: {
        enums.GermanicLanguages.BRITISH_AUSTRALIAN_ENGLISH: [
...
germanic_langs = [
    x.value
    for x in enums.GermanicLanguages
    if x != enums.GermanicLanguages.AMERICAN_ENGLISH
]
...
def _get_array(
    ...
    with connect(f"dbs/{family}/{db_str}") as c:
        cur = c.cursor()
        try:
...
def _get_covariance(
    ...
    Args:
        language_family (enums.LanguageFamily): The language family of the desired spectrogram (i.e., 
                                                either Romance or Germanic).
        language (enums.LanguageFamily): The language for which to get the covariance structure.
    ...
    with connect(f"dbs/{family}/{cov_type}_covariance.db") as c:
        cur = c.cursor()
        try:
    ...
    conn = connect(f"dbs/{family}/{cov_type}_covariance.db")
    cur = conn.cursor()
...
# NOTE: bug has been identified here
def _get_R(
    c1: np.array,
    c2: np.array,
) -> np.array:
...
def _theta_cost_function(
    theta: np.array,
    offset: float,
    centroids: Dict[enums.LanguageFamily, np.array],
    obj_r: Dict[enums.LanguageFamily, float],
    obj_prior_theta: Dict[enums.LanguageFamily, float],
    ...
    Args:
        ...
        offset (float): An angular offset that centers the optimization about a particular
                        quadrant.
        centroids (Dict[enums.LanguageFamily, np.array]): The language centroids with respect
                                                            to which the other disk is being
                                                            rotated.
        obj_r (Dict[enums.LanguageFamily, float]): The r parameters of the polar representations
                                                     of the points in the disk being rotated.
        obj_prior_theta (Dict[enums.LanguageFamily, float]): The theta parameters of the polar
                                                               representations of the points in the
                                                               disk being rotated.
        lang_family (enums.LanguageFamily): The language family used to calculate the cost
