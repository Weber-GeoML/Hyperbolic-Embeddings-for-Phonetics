...
def get_procrustes_distance_R_inf(
    ...
    Args:
        lang1 (enums.LanguageFamily): The first language.
        lang2 (enums.LanguageFamily): The second language.
...
def get_procrustes_distance_svd(
    ...
    Args:
        langfam (enums.LanguageFamily): The language family to which the two languages belong.
        lang1 (enums.LanguageFamily): The first language.
        lang2 (enums.LanguageFamily): The second language.
        cov_type (enums.CovarianceType): The type of the covariance structures in question.
    ...
    c1 = utils._get_covariance(
        language_family=langfam,
        language=lang1, 
        cov_type=cov_type
    )
    c2 = utils._get_covariance(
        language_family=langfam,
        language=lang2, 
        cov_type=cov_type
    )
...
def get_covariance_interpolations(
    ...
    Args:
        lang1 (LanguageFamily): The first language.
        lang2 (LanguageFamily): The second language.
...
def interspeaker_interp(
    ...
    Args:
        langfam (enums.LanguageFamily): The language family to which the two languages belong.
        lang1 (enums.LanguageFamily): The language of the first speaker.
        lang2 (enums.LanguageFamily): The language of the second speaker.
    ...
    cov_time_l1 = get_time_covariance(
        language_family=langfam,
        language=lang1
    )
    cov_time_l2 = get_time_covariance(
        language_family=langfam,
        language=lang2
    )

    cov_freq_l1 = get_freq_covariance(
        language_family=langfam,
        language=lang1
    )
    cov_freq_l2 = get_freq_covariance(
        language_family=langfam,
        language=lang2
    )
